...
###
	...
	if [ $? -ne 0 ]; then
	echo -e "\033[31mPush $repo_name branch multiwindow ERROR!\033[0m"
	fi

	#20160812 push multiwin-english to github
	git push github multiwin-english
	if [ $? -ne 0 ]; then
	echo -e "\033[31mPush $repo_name branch multiwin-english ERROR!\033[0m"
	fi
